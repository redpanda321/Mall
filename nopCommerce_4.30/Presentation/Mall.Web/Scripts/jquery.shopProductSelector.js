...
',
    ...
    reload: function (shopId, selectedProductIds) {
        ...
        $("#_shopProductSelector table").MallDatagrid({
            url: url,
            nowrap: false,
            rownumbers: true,
        ...
        $("#_shopProductSelector .choose-search button").unbind('click').click(function () {
            ...
            $("#_shopProductSelector table").MallDatagrid('reload', $.shopProductSelector.params);
        });
    ...
    getSelected: function () {
        ...
        if (this.multiSelect) {
            ...
            products.push($("#_shopProductSelector table").MallDatagrid('getSelected'));
        }
    ...
    show: function (selectedProductIds, onSelectFinishedCallBack, shopId, multiSelect) {
        ...
        $('#_shopProductSelector select').MallLinkage({
            ...
            onChange: function (level, value) {
                ...
                if (level > 0 && !value) {
                    ...
                    categoryId = $('#_shopProductSelector select').MallLinkage('value', parentLevel);
