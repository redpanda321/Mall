...
Source Server         : 192.168.11.93
Source Server Version : 50717
Source Host           : 192.168.11.93:3306
Source Database       : Mall3.2

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2018-05-30 17:40:31
*/
...
-- ----------------------------
-- Table structure for Mall_AccountDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_AccountMeta
-- ----------------------------
...
CREATE TABLE `Mall_Active` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `IDX_Active_StartTime` (`StartTime`) USING BTREE,
  KEY `IDX_Active_EndTime` (`EndTime`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='营销活动表';

-- ----------------------------
-- Table structure for Mall_ActiveMarketService
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ActiveProduct
-- ----------------------------
...
CREATE TABLE `Mall_ActiveProduct` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `IDX_Accts_ActiveId` (`ActiveId`) USING BTREE,
  KEY `IDX_Accts_ProdcutId` (`ProductId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=696 DEFAULT CHARSET=utf8 COMMENT='营销活动商品';

-- ----------------------------
-- Table structure for Mall_Agreement
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_AppBaseSafeSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ApplyWithDraw
-- ----------------------------
...
ALTER TABLE Mall_ApplyWithDraw MODIFY COLUMN NickName varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;	-- 微信昵称

-- ----------------------------
-- Table structure for Mall_AppMessage
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ArticleCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_AttributeValue
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_AutoReply
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_Bonus
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_BonusReceive
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_BrowsingHistory
-- ----------------------------
...
CREATE TABLE `Mall_BrowsingHistory` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_BrowsingHistory_BrowsingHistory` (`MemberId`) USING BTREE,
  KEY `FK_BrowsingHistory_Products` (`ProductId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4494 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_businesscategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_BusinessCategoryApply
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_BusinessCategoryApplyDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_Capital
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CapitalDetail
-- ----------------------------
...
CREATE TABLE `Mall_CapitalDetail` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_Reference_CapitalDetail` (`CapitalID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_CashDeposit
-- ----------------------------
...
CREATE TABLE `Mall_CashDeposit` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_CashDeposit_Shops` (`ShopId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=gbk;

-- ----------------------------
-- Table structure for Mall_CashDepositDetail
-- ----------------------------
...
CREATE TABLE `Mall_CashDepositDetail` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `KF_CashDeposit_CashDepositDetail` (`CashDepositId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
...
-- ----------------------------
-- Table structure for Mall_CategoryCashDeposit
-- ----------------------------
...
CREATE TABLE `Mall_CategoryCashDeposit` (
  ...
  KEY `FK_CategoriesObligation_Categories` (`CategoryId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_ChargeDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ChargeDetailShop
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CityExpressConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_Collocation
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CollocationPoruduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CollocationSku
-- ----------------------------
...
CREATE TABLE `Mall_Coupon` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_Coupon_Shops` (`ShopId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_CouponProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CouponRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CouponSendByRegister
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CouponSendByRegisterDetailed
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CouponSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_CustomerService
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionBrokerage
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionRanking
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionRankingBatch
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionShopRateConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributionWithdraw
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_Distributor
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributorGrade
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_DistributorRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ExpressElement
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ExpressInfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FavoriteShop
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FightGroup
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FightGroupActive
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FightGroupActiveItem
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FightGroupOrder
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FlashSale
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FlashSaleConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FlashSaleDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FlashSaleRemind
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorBrand
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorTabl
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorTablDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FloorTopic
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FreightAreaContent
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FreightAreaDetail
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FreightTemplate
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_FullDiscountRule
-- ----------------------------
...
CREATE TABLE `Mall_FullDiscountRule` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `IDX_Fules_ActiveId` (`ActiveId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=665 DEFAULT CHARSET=utf8 COMMENT='满减规则';

-- ----------------------------
-- Table structure for Mall_Gift
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_GiftOrder
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_GiftOrderItem
-- ----------------------------
...
CREATE TABLE `Mall_GiftOrderItem` (
  ...
  `ImagePath` varchar(100) DEFAULT NULL COMMENT '图片存放地址',
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_Gitem_OrderId` (`OrderId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_HandSlideAd
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_HomeCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_HomeCategoryRow
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_HomeFloor
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ImageAd
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_IntegralMallAd
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_InviteRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_InviteRule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_InvoiceContext
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_InvoiceTitle
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MarketServiceRecord
-- ----------------------------
...
CREATE TABLE `Mall_MarketServiceRecord` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_MarketServiceRecord_ActiveMarketService` (`MarketServiceId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_MarketSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MarketSettingMeta
-- ----------------------------
...
ALTER TABLE Mall_Member MODIFY COLUMN Nick varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;		-- 微信昵称
ALTER TABLE Mall_Member MODIFY COLUMN RealName varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;	-- 在获取优惠券等地方一键登录昵称给用户真实姓名字段

-- ----------------------------
-- Table structure for Mall_MemberActivityDegree
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberBuyCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberConsumeStatistic
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberContact
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberGrade
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberGroup
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberIntegral
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberIntegralExchangeRule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberIntegralRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberIntegralRecordAction
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberIntegralRule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberLabel
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberOpenId
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MemberSignIn
-- ----------------------------
...
CREATE TABLE `Mall_MemberSignIn` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `IDX_MenIn_UserId` (`UserId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for Mall_MessageLog
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MobileFootMenu
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_MobileHomeProduct
-- ----------------------------
...
CREATE TABLE `Mall_MobileHomeProduct` (
  ...
  `ProductId` bigint(20) NOT NULL COMMENT '商品ID',
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_MobileHomeProducts_Products` (`ProductId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_MobileHomeTopic
-- ----------------------------
...
CREATE TABLE `Mall_MobileHomeTopic` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK__Mo__Topic__02C769E9` (`TopicId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_ModuleProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OpenId
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderComment
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderComplaint
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderExpressData
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderInvoice
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderItem
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderOperationLog
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderPay
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderRefund
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderRefundLog
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_OrderVerificationCode
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PaymentConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PendingSettlementOrder
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PhotoSpace
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PhotoSpaceCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PlatAccount
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_PlatAccountItem
-- ----------------------------
...
CREATE TABLE `Mall_PlatAccountItem` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_Pltem_AccoutID` (`AccoutID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=667 DEFAULT CHARSET=utf8 COMMENT='平台资金流水表';

-- ----------------------------
-- Table structure for Mall_PlatVisit
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductAttribute
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductComment
-- ----------------------------
...
ALTER TABLE Mall_ProductComment MODIFY COLUMN AppendContent varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;-- 评论特殊表情符
ALTER TABLE Mall_ProductComment MODIFY COLUMN ReviewContent varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- ----------------------------
-- Table structure for Mall_ProductCommentImage
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductConsultation
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductDescription
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductDescriptionTemplate
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductLadderPrice
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductRelationProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_productshopcategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ProductVisti
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ReceivingAddressConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_RechargePresentRule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_RefundReason
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_RolePrivilege
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SearchProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SellerSpecificationValue
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SendMessageRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SendmessagerecordCoupon
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SendmessagerecordCouponSN
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SensitiveWord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_Settled
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShippingAddress
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShippingFreeGroup
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShippingFreeRegion
-- ----------------------------
...
ALTER TABLE `Mall_shop` MODIFY COLUMN `WeiXinNickName`  varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; -- 商家提现微信绑定特殊表情符编码设置；
-- ----------------------------
-- Table structure for Mall_ShopAccount
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopAccountItem
-- ----------------------------
...
CREATE TABLE `Mall_ShopAccountItem` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_Shtem_AccoutID` (`AccoutID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=396 DEFAULT CHARSET=utf8 COMMENT='店铺资金流水表';

-- ----------------------------
-- Table structure for Mall_ShopBonus
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBonusGrant
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBonusReceive
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBranch
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBranchInTag
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBranchManager
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBranchSku
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBranchTag
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBrand
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopBrandApply
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopCategory
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopFooter
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopGrade
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopHomeModule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopHomeModuleProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopHomeModuleTopImg
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopInvoiceConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopOpenApiSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShoppingCart
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopRenewRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopShipper
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopVisti
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopWdgjSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_ShopWithDraw
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SiteSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SiteSignInConfig
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SlideAd
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_SpecificationValue
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_StatisticOrderComment
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_TemplateVisualizationSetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_TopicModule
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_TypeBrand
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VerificationRecord
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VirtualOrderItem
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VirtualProduct
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VirtualProductItem
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VShop
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_VShopExtend
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WeiActivityAward
-- ----------------------------
...
CREATE TABLE `Mall_WeiActivityAward` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_WeiActivityAward_2` (`ActivityId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=369 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_WeiActivityInfo
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WeiActivityWinInfo
-- ----------------------------
...
CREATE TABLE `Mall_WeiActivityWinInfo` (
  ...
  `AddDate` datetime NOT NULL,
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_WeiActivityWinInfo_W2` (`ActivityId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_WeiXinBasic
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WeiXinMsgTemplate
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WXAccToken
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WXAppletFormData
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WXCardCodeLog
-- ----------------------------
...
CREATE TABLE `Mall_WXCardCodeLog` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `FK_WXLog_CardLogId` (`CardLogId`) USING BTREE,
  KEY `IDX_WXLog_CardId` (`CardId`) USING BTREE,
  KEY `IDX_WXLog_Code` (`Code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_WXCardLog
-- ----------------------------
...
CREATE TABLE `Mall_WXCardLog` (
  ...
  PRIMARY KEY (`Id`) USING BTREE,
  KEY `IDX_WXCardLog_CardId` (`CardId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for Mall_WXshop
-- ----------------------------
...
-- ----------------------------
-- Table structure for Mall_WXSmallChoiceProduct
-- ----------------------------
...
ALTER TABLE `Mall_Distributor`
ADD COLUMN `IsShowShopLogo`  bit(1) NOT NULL DEFAULT 1 COMMENT '是否展示小店logo' AFTER `ShopLogo`;

ALTER TABLE `Mall_Shop`
MODIFY COLUMN `BusinessSphere`  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '法定经营范围' AFTER `BusinessLicenceEnd`;
