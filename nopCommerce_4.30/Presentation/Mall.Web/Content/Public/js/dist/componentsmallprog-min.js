...
HiShop.popbox.dplPickerColletion = function (a) {
    ...
    switch (parseInt(c.linkType)) {
        ...
        case 6: //限时购列表
            var d = {
                title: "限时购列表",
                link: "../countdown/countdown",
                pc_link: "/LimitTimeBuy/home"
        ...
        case 9: //拼团列表
            var d = {
                title: "拼团列表",
                //link: "../GroupBuyList.aspx"
                link: "../grouplist/grouplist"
            };
            c.callback(d, 9);
            break;
        case 7: //签到
        ...
        case 24://积分商城
            var d = {
                title: "积分商城",
                link: "../pointsShoppingCenter/pointsShoppingCenter"
            };
            c.callback(d, 24);
            break;
        case 26://积分商城
            var d = {
                title: "商品分类",
                link: "../productcategory/productcategory"
            };
            c.callback(d, 26);
            break;
    }
