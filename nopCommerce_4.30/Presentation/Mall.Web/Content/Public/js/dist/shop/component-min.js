...
HiShop.popbox.GoodsAndGroupPicker = function (a, b,old) {
    ...
    switch (a) {
        ...
        case "goodsMulti":
            ...
            i(1,
            function () {
                var b = '<span class="fl">商品分类</span><div class="goodsearch"><select></select><select></select><select></select><input style="width:250px" type="text" name="title" placeholder="请输入商品名称" /><a href="javascript:;" class="btn btn-primary jGetgood"><i class="gicon-search white"></i>查询</a></div>';
                $.jBox.show({
                    title: b,
                    content: f,
                    btnOK: {
                            ...
                            e = function (a, i) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        p: parseInt(a),
                                        title: b,
                                        categoryId:categoryId//xlx新增分类搜索条件
                                        //status: d  修改前未用到的参数，去掉d
                                    },
                                    success: function (a) {
