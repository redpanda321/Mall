...
namespace Mall.Web.Controllers
{
    public class SiteController : Controller
    {
        ...
        {
            string path = Path.Combine( AppDomain.CurrentDomain.BaseDirectory , "bin" , "Mall.Web.dll" );
        ...
        public object GetAppDataUrl()
        {
            try
            {
                ...
                var appUrl = _configuration.GetSection("AppDateUrl").Value;
