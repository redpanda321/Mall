    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            /*
                        ...
                        foreach (IRouter r in routes)
                        {
                            if (r.GetType() == typeof(LocalizedRoute))
                            {
                                LocalizedRoute router = (LocalizedRoute)r;
            ...
            */
            ...
            /*
            var routes = endpointRouteBuilder.Routes;
            foreach (IRouter r in routes)
            {
            ...
            */
            ...
            endpointRouteBuilder.MapAreaControllerRoute(
                       name: "Mobile_default",
                      areaName: "Mobile",
                       pattern: "m-{platform}/{controller}/{action}/{id?}",
                       defaults: new { controller = "Home", action = "Index" }
                    );
            ...
            endpointRouteBuilder.MapAreaControllerRoute(
                       name: "Mobile_default2",
                        areaName: "Mobile",
                       pattern: "m/{controller}/{action}/{id?}",
            ...
            endpointRouteBuilder.MapAreaControllerRoute(
                        name: "Mobile_isshare",
                        areaName: "Mobile",
                        pattern: "m-{platform}/{controller}/{action}/{id?}/{isShare}",
                        defaults: new { controller = "Home", action = "Index" }
                   );
            ...
            endpointRouteBuilder.MapAreaControllerRoute(
                        ...
                        areaName: "Mobile",
                        pattern: "m-{platform}/{controller}/{action}/{id?}/{openId}/{isShare}",
                        defaults: new { controller = "Home", action = "Index" }
                   );
            ...
            endpointRouteBuilder.MapAreaControllerRoute(
                   ...
                   pattern: "selleradmin/{controller}/{action}/{id?}",
                   defaults: new { controller = "home", action = "Index" }
                  );
            ...
            endpointRouteBuilder.MapControllerRoute(
                        name: "Default",
                        pattern: "common/{controller}/{action}/{id?}",
                        defaults: new { controller = "Home", action = "Index" },
                        constraints: null
                    );
            ...
            endpointRouteBuilder.MapControllerRoute(
                        name: "MiniApi",
                        pattern: "miniprogapi/{controller}/{action}/{id?}",
            ...
            endpointRouteBuilder.MapControllerRoute(
                   name: "DefaultOpenApi",
                 pattern: "openapi/Hishop.Open.Api.I{controller}.{action}/{id?}",
