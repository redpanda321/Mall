...
(function ($) {
	...
	$.fn.MallUpload = function (options, param) {
	    if (typeof options == "string") {
	        return $.fn.MallUpload.methods[options](this, param);
	    }
	    options = options || {};
	    return this.each(function () {
	        var opts = $.extend({}, $.fn.MallUpload.defaults, options);
	        opts.view.render.call(opts.view, opts, $(this));
	        bindEvent(this, opts);
	    });
	};

	$.fn.MallUpload.methods = {
