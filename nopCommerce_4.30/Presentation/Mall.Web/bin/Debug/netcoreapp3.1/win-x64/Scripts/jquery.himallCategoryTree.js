(function ($) {
    ...
    function initLoad() {
        var html = '';
        initTable();
        $.post($.fn.MallCategoryTree.options.dataUrl, { parentId: 0 }, function (data) {
    ...
    $.fn.MallCategoryTree = function (options) {
        container = $(this);
        $.fn.MallCategoryTree.options = $.extend({}, $.fn.MallCategoryTree.options, options);
