...
function sendPhoneCode() {
    ...
    $.post('SendCode', { pluginId: "Mall.Plugin.Message.SMS", destination: Phone }, function (result) {
        if (result.success) {
            var count = 120;
            $("#pcv").show();
...
function sendEmailCode() {
    ...
    $.post('SendCode', { pluginId: "Mall.Plugin.Message.Email", destination: Email }, function (result) {
        if (result.success) {
            var count = 120;
            $("#ecv").show();
