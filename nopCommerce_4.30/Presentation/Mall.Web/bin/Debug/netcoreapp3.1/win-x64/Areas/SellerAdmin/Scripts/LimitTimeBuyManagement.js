...
$(function () {
    ...
    $("#list").on("click", ".bt-end", function () {
        ...
        $.dialog.confirm('该活动将立即结束，是否继续？', function () {
            ...
            $.post("/SellerAdmin/LimitTimeBuy/EndActive", { id: id }, function () {
                loading.close();
    ...
    function LoadLimitBuy() {
        ...
        $("#list").MallDatagrid({
            ...
            [[
                ...
                { field: "BeginDate", title: "开始时间", width: 150, align: "center",sort:true },
                { field: "EndDate", title: "结束时间", width: 150, align: "center", sort: true },
                { field: "LimitCountOfThePeople", title: "限购数", width: 60, align: "center", sort: true},
                { field: "SaleCount", title: "销售数", width: 60, align: "center", sort: true},
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        switch (row.StatusNum) {
                            ...
                            case 2:
                                ...
                                html.push("<a class=\"good-check bt-end\" href=\"javascript:;\" data-id=\"" + id + "\">提前结束</a></span>");
                                break;
                        }
