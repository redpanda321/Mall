var datacols = [[
             ...
             { field: "OrderAmount", title: "订单实付", width: 80, align: "center" },
             { field: "IntegralDiscount", title: "扣分抵扣", width: 'auto', align: "center" },
...
$(function () {
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").MallDatagrid('reload', { startDate: startDate, endDate: endDate, BillingstartDate: BillingstartDate, BillingendDate: BillingendDate, orderId: orderId,detailId:detailId });
    })
});
