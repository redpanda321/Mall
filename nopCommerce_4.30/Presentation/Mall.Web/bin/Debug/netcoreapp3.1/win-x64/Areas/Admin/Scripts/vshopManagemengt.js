...
function bindSearchBtn()
{
    ...
    var vshopIsOpen = $( '#vshopIsOpen' ).val();
    $("#list").MallDatagrid('reload', { vshopName: vshopName, vshopType: vshopState, vshopIsOpen: vshopIsOpen } );
}
...
function initGrid()
{
    ...
    $( "#list" ).MallDatagrid( {
        ...
        [[
            ...
            {
                field: "IsOpenStr", title: '状态', align: "center"
            },
            {
            ...
            },
            {
                ...
                formatter: function ( value, row, index )
                {
                    ...
                    if (row.IsOpen == false) {
                        //html += "<a class='good-open'>开启</a><input class='thisId' type='hidden' value=" + row.id + "><input class='thisName' type='hidden' value=" + row.name + "></span>";
                    } else {
