...
namespace Mall.Web.Areas.SellerAdmin.Models
{
    public class ShopBonusModel
    {
        ...
        public static implicit operator Entities.ShopBonusInfo( ShopBonusModel m )
        {
            return new Entities.ShopBonusInfo
            {
                Id = m.Id ,
                Count = m.Count ,
                RandomAmountStart = m.RandomAmountStart ,
        ...
        public Entities.ShopBonusInfo.UseStateType UseState { get; set; }
