var datacols = [[
             ...
             { field: "OrderAmount", title: "订单实付", width: 120, align: "center" },
             ...
             { field: "CreateDateStr", title: "订单付款时间", width: 160, align: "center" },
              {
...
$(function () {
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").MallDatagrid('reload', { startDate: startDate, endDate: endDate, orderId: orderId });
    })
});
