...
function Query() {
    ...
    $("#shopDatagrid").MallDatagrid({
        ...
        [[
            ...
            { field: "totalBalance", title: "缴纳保证金", width: 130, sort: true },
            { field: "currentBalance", title: "当前余额", width: 130, sort: true },
            { field: "needPay", title: "应缴金额", width: 130/*, sort: true*/},
            { field: "date", title: "最近缴纳时间", width: 140, sort: true},
            {
