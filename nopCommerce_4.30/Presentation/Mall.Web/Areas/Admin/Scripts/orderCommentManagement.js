function query()
{
    ...
    $("#list").MallDatagrid({
        ...
        [[
            ...
            { field: "PackMark", title: "商品描述", width: 100, align: "center" },
            { field: "DeliveryMark", title: "物流服务", width: 100, align: "center" },
            { field: "ServiceMark", title: "服务态度", width: 100, align: "center" },
