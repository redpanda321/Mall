...
$('#searchButton').click(function (e) {
    ...
    $("#list").MallDatagrid('reload', { vshopName: vshopName, startTime: sTime, endTime: eTime });
    searchClose(e);
});
...
$('#searchReplaceVShopButton').click(function () {
    ...
    $("#repaceList").MallDatagrid('reload', { vshopName: vshopName, vshopType: 0 });
});
