    ...
    switch (val) {
        ...
        case 2:
            ...
            dataColumn.push({
                ...
                formatter: function (value, row, index) {
                    var html = row.Amount - row.PresentAmount;
                    return html;
                }
            });
            dataColumn.push({
            ...
            dataColumn.push({ field: "SourceData", title: '充值单号', width: 120 });
            break;
        case 3:
        ...
        case 4:
            ...
            dataColumn.push({
                ...
                formatter: function (value, row, index) {
                    var html = '<a href="/Admin/Order/Detail/' + row.SourceData + '">' + row.SourceData + '</a>';
                    return html;
                }});
            break;
        case 5:
            ...
            dataColumn.push({ field: "SourceData", title: '单号', width: 120 });
            break;
        case 6:
            dataColumn.push({
            ...
            dataColumn.push({ field: "Remark", title: '备注', width: 120 });
            break;
    }
    $("#list").empty();
    $("#list").MallDatagrid({
