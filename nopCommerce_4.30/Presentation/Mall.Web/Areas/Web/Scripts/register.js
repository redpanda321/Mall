...
function checksysCheckCodeIsValid() {
    ...
    var pluginId = "Mall.Plugin.Message.SMS";
...
function checkCheckCodeIsValid() {
    ...
    //        type: "post",
    //        url: "/register/CheckCode",
    //        data: { pluginId: "Mall.Plugin.Message.SMS", code: checkCode, destination: $("#cellPhone").val() },
    //        dataType: "json",
    //        async: false,
    //        success: function (data) {
    //            if (data.success == true) {
...
function sendmCode() {
    ...
    jQuery.ajax({
        type: "post",
        url: "/Register/SendCode?pluginId=Mall.Plugin.Message.SMS&destination=" + $("#cellPhone").val() + "&imagecheckCode=" + checkCode,
...
function sendemCode() {
    ...
    jQuery.ajax({
        type: "post",
        url: "/Register/SendCode?pluginId=Mall.Plugin.Message.Email&destination=" + $("#callEmail").val() + '&imagecheckCode=' + checkCode,
        success: function (result) {
            if (result.success == true) {
                $("#callEmail_error").hide();
