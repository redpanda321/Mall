...
namespace Mall.Web.Areas.Web.Models
{
    public class ProductDetailModelForWeb
    {
        ...
        public DTO.CashDepositsObligation CashDepositsObligation { get; set; }
        ...
        public Entities.VirtualProductInfo VirtualProductInfo { get; set; }
    ...
    public class LimitTimeProductDetailModel : ProductDetailModelForWeb
    {
        ...
        public DTO.CashDepositsObligation CashDeposits { get; set; }

        public bool IsFavorite { get; set; }

        public IOrderedEnumerable<Entities.CustomerServiceInfo> Service { get; set; }
