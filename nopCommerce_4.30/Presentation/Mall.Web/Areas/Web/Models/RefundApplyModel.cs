...
namespace Mall.Web.Areas.Web.Models
{
    public class RefundApplyModel
    {
        ...
        {
            OrderItems = new List<Entities.OrderItemInfo>();
        }
        /// <summary>
        /// 是否整笔退
        /// </summary>
        ...
        /// 订单
        /// </summary>
        public Entities.OrderInfo OrderInfo { get; set; }
        /// <summary>
        /// 订单项
        /// </summary>
        public List<Entities.OrderItemInfo> OrderItems { get; set; }
        /// <summary>
        /// 订单项编号
        /// </summary>
        ...
        /// 售后类型
        /// </summary>
        public Entities.OrderRefundInfo.OrderRefundMode? RefundMode { get; set; }
        /// <summary>
        /// 最大可退金额
        /// </summary>
        ...
        /// 退款方式
        /// </summary>
        public Entities.OrderRefundInfo.OrderRefundPayType? RefundWayValue { get; set; }
        /// <summary>
        /// 退款原因
        /// </summary>
