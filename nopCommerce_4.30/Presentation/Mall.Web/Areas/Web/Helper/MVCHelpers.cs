namespace Microsoft.AspNetCore.Mvc
{
    ...
    public static class MVCHelpers
    {
             ...
             //   tagPrior.InnerHtml = "上一页";
                ...
                if (pagingInfo.CurrentPage <= 5)
                {
                    ...
                    for (int i = start; i < 8 && i <= pagingInfo.TotalPages; i++)
                    {
                        ...
                        temp.InnerHtml.Append( i.ToString());
                ...
                if (pagingInfo.CurrentPage > 5 && pagingInfo.CurrentPage + 5 <= pagingInfo.TotalPages)
                {
                    ...
                    {
                        TagBuilder temp = new TagBuilder("a");
                        temp.InnerHtml.Append( (i - 2).ToString());
        ...
        public static HtmlString CategoryPath(string path, string pName)
        {
        ...
        /// <param name="pagingInfo"></param>
        /// <returns></returns>
        public static HtmlString PageShow(this IHtmlHelper html, PagingInfo pagingInfo)
        {
