...
namespace Mall.Web.Models
{
    public class ShopGradeModel
    {
        ...
        { }
        public ShopGradeModel(Entities.ShopGradeInfo m)
            : this()
        {
            this.Id = m.Id;
            this.Name = m.Name;
        ...
        public static implicit operator Entities.ShopGradeInfo(ShopGradeModel m)
        {
            return new Entities.ShopGradeInfo
            {
                Id = m.Id,
