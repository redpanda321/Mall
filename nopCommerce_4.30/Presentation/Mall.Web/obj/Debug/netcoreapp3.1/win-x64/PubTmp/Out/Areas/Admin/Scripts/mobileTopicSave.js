...
function generateTopicInfo() {
    ...
    topic.name = $('#Name').val();
    topic.frontCoverImage = $("#topImage").MallUpload('getImgSrc');
    topic.topImage = $("#topImage").MallUpload('getImgSrc');
    topic.backgroundImage = $("#backgroudImage").MallUpload('getImgSrc');
