$(function () {
    ...
    HiShop.DIY.Unit.event_type8 = function (ctrldom, data) {
        ...
        $ctrl.find(".ctrl-item-list-add").click(function () {
            var newdata = {
                ...
                title: "",
                showtitle: "",
                pic: "/Content/Public/images/diy/app/group_120_120.png"
            };
            data.content.dataset.push(newdata);
            reRender();
        });
    ...
    HiShop.DIY.Unit.event_type9 = function (ctrldom, data) {
        ...
        $ctrl.find(".ctrl-item-list-add").click(function () {
            var newdata = {
                ...
                title: "",
                showtitle: "",
                pic: "/Content/Public/images/diy/app/group_750_350.png"
            };
            data.content.dataset.push(newdata);
            reRender();
        });
    ...
    //模块类型20-24 APP专题
    HiShop.DIY.Unit.event_type20 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
            tpl_con = $("#tpl_diy_con_type20").html(),//手机内容模板
            tpl_ctrl = $("#tpl_diy_ctrl_type20").html();//控制内容模板
        ...
        var reRender = function (callback) {
            ...
            var $render_ctrl = $(_.template(tpl_ctrl, data));
            $ctrl.empty().append($render_ctrl);
            HiShop.DIY.Unit.event_type20($ctrl, data);
            if (callback) callback();
        }
        // 设置宽高
        var setImgHeight = function () {
        ...
        $ctrl.find("input[name='customtel']").change(function () {
            var index = $(this).parents("li.ctrl-item-list-li").index();
            data.content.dataset[index].link = $(this).val();
        });
    ...
    HiShop.DIY.Unit.event_type21 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
            tpl_con = $("#tpl_diy_con_type21").html(),//手机内容模板
            tpl_ctrl = $("#tpl_diy_ctrl_type21").html();//控制内容模板
        ...
        var reRender = function (callback) {
            ...
            var $render_ctrl = $(_.template(tpl_ctrl, data));
            $ctrl.empty().append($render_ctrl);
            HiShop.DIY.Unit.event_type21($ctrl, data);
            if (callback) callback();
        }
        // 设置宽高
        var setImgHeight = function () {
    ...
    HiShop.DIY.Unit.event_type22 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
            tpl_con = $("#tpl_diy_con_type22").html(),//手机内容模板
            tpl_ctrl = $("#tpl_diy_ctrl_type22").html();//控制内容模板
        ...
        var reRender = function (callback) {
            ...
            var $render_ctrl = $(_.template(tpl_ctrl, data));
            $ctrl.empty().append($render_ctrl);
            HiShop.DIY.Unit.event_type22($ctrl, data);
            if (callback) callback();
        }
        // 设置宽高
        var setImgHeight = function () {
    ...
    HiShop.DIY.Unit.event_type23 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
            tpl_con = $("#tpl_diy_con_type23").html(),//手机内容模板
            tpl_ctrl = $("#tpl_diy_ctrl_type23").html();//控制内容模板
        ...
        var reRender = function (callback) {
            ...
            var $render_ctrl = $(_.template(tpl_ctrl, data));
            $ctrl.empty().append($render_ctrl);
            HiShop.DIY.Unit.event_type23($ctrl, data);
            if (callback) callback();
        }
        // 设置宽高
        var setImgHeight = function () {
    ...
    HiShop.DIY.Unit.event_type24 = function (ctrldom, data) {
        var $conitem = data.dom_conitem, //手机内容
            $ctrl = ctrldom, //控制内容
            tpl_con = $("#tpl_diy_con_type24").html(),//手机内容模板
            tpl_ctrl = $("#tpl_diy_ctrl_type24").html();//控制内容模板
            ...
            HiShop.popbox.dplPickerColletion({
                ...
                callback: function (item, type) {
                    ...
                    if (item.pic && item.pic != "") {
                        ...
                        var i = new Image();
                        i.src = item.pic;
                        data.content.dataset[index].picHeight = i.height;
                    }
                    reRender();
                }
            });
