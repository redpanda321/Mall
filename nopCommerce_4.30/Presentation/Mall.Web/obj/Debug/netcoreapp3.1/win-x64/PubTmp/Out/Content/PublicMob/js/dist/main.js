...
$(function () {
    var a = function (a) {
        ...
        return c = a.match(e),
        d = a.match(f),
        c && (c = c.toString(), b = "https://v.qq.com/iframe/player.html?" + c + "&tiny=0&auto=0"),
        d && (d = d.toString(), d = d.split("/v.swf"), d = d.toString(), d = d.replace("sid/", "").replace(",", ""), b = "https://player.youku.com/embed/" + d),
        b
    };
