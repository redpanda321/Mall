...
//商品选择公共处理方法，方法在模块中调用，即diy.event.js内，新增old参数，逻辑改为传入初始化上次选择商品 2018.02.27 xlx mark
HiShop.popbox.GoodsAndGroupPicker = function (a, b, old) {
    ...
    switch (a) {
        ...
        case "goodsMulti":
            ...
            i(1,
            function () {
                var b = '<span class="fl">商品分类</span><div class="goodsearch"><select></select><select></select><select></select><input type="text" class="goodsname" name="title" placeholder="商品名称" /><input type="text" class="shopname" name="title" placeholder="商家名称" /><a href="javascript:;" class="btn btn-primary jGetgood"><i class="gicon-search white"></i>查询</a></div>';
                $.jBox.show({
                    title: b,
                    content: f,
                    btnOK: {
                    ...
                    onOpen: function (b) {
                        ...
                        $('.goodsearch select').MallLinkage({
				            ...
				            onChange: function (level, value) {
				                ...
				                if (level > 0 && !value)
				                {
				                    ...
				                    categoryId = $('.goodsearch select').MallLinkage('value', parentLevel);
				                    if (parentLevel > 0 && !categoryId) {
				                        parentLevel--;
				                        categoryId = $('.goodsearch select').MallLinkage('value', parentLevel);
				                    }
				                }
				                $('.goodsearch').data('categoryid',categoryId);
				            }
				        });
                        ...
                        function (a) {
                            ...
                            s = $(this).siblings("input.shopname").val(),
                        	categoryId=$('.goodsearch').data('categoryid'),
                            ...
                            e = function (a, i) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        p: parseInt(a),
                                        title: b,
                                        shopname:s,//xlx新增商家、分类搜索条件
                                        categoryId:categoryId
                                        //status: d  修改前未用到的参数，去掉
                                    },
                                    success: function (a) {
...
HiShop.popbox.GiftPicker = function (a, b) {
    var c, d, e = $("#tpl_popbox_GiftPicker").html(),
    f = $(e),
    g = [],
    h = [],
    i = function (a, b) {
        var d = function (a) {
            if (c = a.list, c && c.length) {
                var d = $("#tpl_popbox_GiftPicker_graphicsitem").html(),
                e = _.template(d, {
                    dataset: c
                }),
                j = $(e);
        ...
        $.ajax({
            ...
            url: HiShop.Config.AjaxUrl.GiftList,
            type: "post",
            dataType: "json",
            data: {
                p: parseInt(a)
    ...
    switch (a) {
        case "all":
            ...
            i(1,
            function () {
                var b = '<span class="fl">选择礼品</span><div class="goodsearch"><input type="text" name="title" placeholder="请输入礼品名称" /><a href="javascript:;" class="btn btn-primary jGetgood"><i class="gicon-search white"></i>查询</a></div>';
                $.jBox.show({
                    title: b,
                    content: f,
                    btnOK: {
                    ...
                    onOpen: function (b) {
                        ...
                        function (a) {
                            ...
                            e = function (a, i) {
                                ...
                                var j = function (a) {
                                    if (c = a.list, c && c.length) {
                                        var b = $("#tpl_popbox_GiftPicker_graphicsitem").html(),
                                        d = _.template(b, {
                                            dataset: c
                                        }),
                                        j = $(d);
...
HiShop.popbox.dplPickerColletion = function (a) {
    ...
    switch (parseInt(c.linkType)) {
        ...
        case 16: //周边门店
            var d = {
                title: "周边门店",
                link: "/m-wap/shopbranch/storelist"
            };
            c.callback(d, 15);
            break;
        case 17: //其它小程序链接
        ...
        case 24://积分商城
            ...
            break;
        case 25://礼品详情
            HiShop.popbox.GiftPicker("all", c.callback);
            break;
        case 26://分类
            var d = {
                title: "分类",
