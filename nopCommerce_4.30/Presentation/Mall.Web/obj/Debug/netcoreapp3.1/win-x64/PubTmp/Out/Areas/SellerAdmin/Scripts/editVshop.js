...
function formValid() {
    var logo = $("#logo").MallUpload('getImgSrc');
    var frontCover = $('#frontCover').MallUpload('getImgSrc');
    var wxlogo = $('#wxlogobox').MallUpload('getImgSrc');
    var str = $('#tags').val();
    if (str != '') {
