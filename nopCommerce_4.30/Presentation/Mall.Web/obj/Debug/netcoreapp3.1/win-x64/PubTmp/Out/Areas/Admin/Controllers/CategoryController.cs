...
namespace Mall.Web.Areas.Admin.Controllers
{
    public class CategoryController : BaseAdminController
    {
        ...
        {
            return Json(new { success = true, depth = _iCategoryService.GetCategory(id).Depth });
        }
        ...
        public ActionResult Add(CategoryModel category)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    dataisok = false;
                    //throw new Mall.Core.MallException("已存在相同分类名");
        ...
        public ActionResult GetCategoryByParentId(int id)
        {
            ...
            return Json(new { Successfly = true, Category = list });
        }
        ...
        private void ProcessingIcon(CategoryModel model, ICategoryService IProductCategory)
        {
            if (!string.IsNullOrWhiteSpace(model.Icon))
            {
                ...
                if (model.Icon.Contains("/temp/"))
                {
                    ...
                    Core.MallIO.CopyFile(source, model.Icon, true);
                }
        ...
        public JsonResult SetSupportVirtualProduct(bool supportVirtualProduct, long id)
        {
            var cateInfo = _iCategoryService.GetCategory(id);
            if (cateInfo == null)
                return Json(new Result { success = false, msg = "错误的分类" });
        ...
        public JsonResult GetSecondAndThirdCategoriesByTopId(long id)
        {
            ...
            return Json(new { success = true, categoies = categoies });
        }
