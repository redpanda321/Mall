...
namespace Mall.Web.Areas.Admin.Models
{
    public class GiftViewModel
    {
        ...
        [Range(0, int.MaxValue, ErrorMessage = "虚拟销量不可为负数")]
        public int VirtualSales { get; set; }
        public int RealSales { get; set; }
        public Entities.GiftInfo.GiftSalesStatus SalesStatus { get; set; }
        public string ImagePath { get; set; }
        public int Sequence { get; set; }
        [Required(ErrorMessage = "请填写礼品价值")]
        [Range(0.01, 99999, ErrorMessage = "礼品价值应在0.01-99999之间")]
        [RegularExpression(@"^\d+(\.\d+)*$", ErrorMessage = "必须是数字")]
        [Display(Name = "礼品价值")]
