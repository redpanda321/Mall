...
$.productSelector = {
    params: { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: false, exceptProductIds: [], productType: 0 },
    serviceType: 'admin',
    multiSelect: true,    
    selectedProducts: [],
    controller:'',
    ...
    reload: function (selectedProductIds, exceptProductIds) {
        ...
        if (this.serviceType == 'admin')
            ...
            if (this.controller == 'distribution' || this.controller == 'appvshophome') {
                $.productSelector.params.productType = -1;
            }
        }
        else if (this.serviceType == 'distribution')
            url = '/Admin/DistributionShop/ProductLists';
        else if (this.serviceType == 'shopbranch')
            url = '/selleradmin/shopbranch/Browse';
        else
            url = '/product/list';
    ...
    clear: function () {
        ...
        this.params = { auditStatus: 2, saleStatus: 1, selectedProductIds: [], isShopCategory: shopCategory, productType: 0 };
    },
    ...
    show: function (selectedProductIds, onSelectFinishedCallBack, serviceType, multiSelect, exceptProductIds, operationButtons, controller) {
