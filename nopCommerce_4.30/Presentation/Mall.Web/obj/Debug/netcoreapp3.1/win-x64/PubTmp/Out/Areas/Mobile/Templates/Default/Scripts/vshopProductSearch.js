...
function init() {
    ...
    $('.fixed-inner a').not('.switch').click(function () {
        ...
        if (!$.trim(keywords))
            keywords = '';
        location.href = '?vshopid=' + vshopId + '&keywords=' + keywords + '&shopCid=' + cid + '&b_id=' + b_id + '&orderKey=' + $(this).attr('orderKey') + '&orderType=' + orderType;
    });
            ...
            , function (result) {
                ...
                if (products.length > 0) {
                    ...
                    $.each(products, function (i, product) {
                        html += ' <li productid="' + product.id + '" price="' + product.price + '">\
