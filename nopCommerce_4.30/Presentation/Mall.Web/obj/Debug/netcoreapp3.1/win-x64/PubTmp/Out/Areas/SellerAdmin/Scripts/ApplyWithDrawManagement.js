$(function () {
    ...
    $("#list").MallDatagrid({
        ...
        [[
            ...
            { field: "AccountNoText", title: "交易流水号", width: 140 }
        ]]
    });
    ...
    $('#searchButton').click(function (e) {
        ...
        $("#list").MallDatagrid('reload', { startDate: startDate, endDate: endDate, startDates: startDates, endDates: endDates, WithdrawStaus: WithdrawStaus });
    });
});
