$(function () {
    ...
    $("#list").MallDatagrid({
        ...
        pagePosition: 'bottom',
        pageNumber: 1,
        queryParams: { status: $("#AuditStatus").val() },
        columns:
        [[
            ...
            { field: "BeginDate", title: "开始时间", width: 110, align: "center", sort: true },
            { field: "EndDate", title: "结束时间", width: 110, align: "center", sort: true },
            { field: "SaleCount", title: "购买数", width: 60, align: "center", sort: true },
            {
