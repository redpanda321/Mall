    ...
    if (ExpressCompanyName != "" & ShipOrderNumber != "") {
        ...
        $.post('/Common/ExpressData/Search', { expressCompanyName: ExpressCompanyName, shipOrderNumber: ShipOrderNumber }, function (result) {
            ...
            if (obj.success) {
                ...
                html += '<div class="form-group clearfix">暂无物流信息，请稍后再试；如有信息推送不及时，请前往物流官网查询！<a href="https://www.kuaidi100.com/chaxun?nu=' + ShipOrderNumber +'" target="_blank">快递100查询</a></div>';
            }
