...
namespace Mall.Web.Areas.SellerAdmin.Controllers
{
    public class PoiController : BaseSellerController
    {
        ...
        private Entities.WXshopInfo _settings;
        bool _isdeploy = true;
        ...
        public ActionResult Save(PoiEditModel model)
        {
            ...
            {
                string path = IOHelper.GetMapPath("~" + model.photo_list);
            ...
            if (model.id == 0)
            {
                ...
                var province = Mall.Application.RegionApplication.GetRegion(model.RegionId, CommonModel.Region.RegionLevel.Province);
                var city = Mall.Application.RegionApplication.GetRegion(model.RegionId, CommonModel.Region.RegionLevel.City);
                var county = Mall.Application.RegionApplication.GetRegion(model.RegionId, CommonModel.Region.RegionLevel.County);
