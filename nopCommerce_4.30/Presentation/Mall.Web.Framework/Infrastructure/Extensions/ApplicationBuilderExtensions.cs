...
namespace Mall.Web.Framework.Infrastructure.Extensions
{
    /// <summary>
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static void StartEngine(this IApplicationBuilder application)
        {
            ...
            if (DataSettingsManager.DatabaseIsInstalled)
            {
                ...
                Nop.Services.Tasks.TaskManager.Instance.Initialize();
                Nop.Services.Tasks.TaskManager.Instance.Start();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseMallStaticFiles(this IApplicationBuilder application)
        {
           ...
           */
           ...
           fileProvider.MapPath(@"private")),
            ...
            {
                FileProvider = new PhysicalFileProvider(
            fileProvider.MapPath(@"AppletHome")),
            ...
            var staticFileOptions = new StaticFileOptions
            {
                FileProvider = new PhysicalFileProvider(fileProvider.MapPath(@"PluginsEx")),
                RequestPath = new PathString("/PluginsEx"),
                OnPrepareResponse = staticFileResponse
            };
