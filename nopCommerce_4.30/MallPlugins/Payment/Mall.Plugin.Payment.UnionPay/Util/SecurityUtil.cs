...
namespace Mall.Plugin.Payment.UnionPay.Util
{
    public static class SecurityUtil
    {

        public static string ALGORITHM_SHA1 = "SHA1";
        static ChinaUnionConfig CUConfig = new ChinaUnionConfig();
        ...
        public static byte[] encryptedData(byte[] encData, string EncryptCert)
        {
            try
            {
                X509Certificate2 pc = new X509Certificate2(EncryptCert);
        ...
        public static string EncryptPin(string pin, string card, string encoding, string EncryptCert)
        {
            ...
            try
            {
                data = encryptedData(pinBlock, EncryptCert);
        ...
        public static string EncryptData(string dataString, string encoding, string EncryptCert)
        {
            ...
            try
            {
                data = encryptedData(UTF8Encoding.UTF8.GetBytes(dataString), EncryptCert);
                return EncodeBase64(Encoding.Default, System.Text.Encoding.Default.GetString(data));
            }
            catch (Exception e)
            {
