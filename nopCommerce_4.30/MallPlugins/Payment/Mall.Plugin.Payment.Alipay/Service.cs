...
namespace Mall.Plugin.Payment.Alipay
{
    public class Service :_ServiceBase, IPaymentPlugin
    {
        ...
        public PaymentInfo ProcessReturn(IHttpContextAccessor context)
        {
        ...
        public PaymentInfo ProcessNotify(IHttpContextAccessor context)
        {
            var queryString = GetQuerystring(context);
        ...
        NameValueCollection GetQuerystring(IHttpContextAccessor context)
        {
        ...
        public Mall.Core.Plugins.FormData GetFormData()
        {
            Config config = Utility<Config>.GetConfig(WorkDirectory);

            var formData = new Mall.Core.Plugins.FormData()
            {
                Items = new Mall.Core.Plugins.FormData.FormItem[] { 

                    //Partner
                   new  Mall.Core.Plugins.FormData.FormItem(){
                     DisplayName = "合作者身份ID",
                     Name = "Partner",
                     IsRequired = true,
                      Type= Mall.Core.Plugins.FormData.FormItemType.text,
        ...
        public PaymentInfo ProcessRefundReturn(HttpContextAccessor context)
        {
