...
namespace Mall.Plugin.Message.Email
{
    class EmailCore
    {
        ...
        public static void SaveMessageContentConfig(MessageContent config)
        {
            ...
            string sDirectory = Mall.Core.Helper.IOHelper.urlToVirtual(WorkDirectory) + "/Data/MessageContent.config";
        ...
        {
            string sDirectory = Mall.Core.Helper.IOHelper.urlToVirtual(EmailCore.WorkDirectory) + "/Data/config.xml";
