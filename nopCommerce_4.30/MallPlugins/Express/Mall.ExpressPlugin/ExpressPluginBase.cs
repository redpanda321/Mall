...
namespace Mall.ExpressPlugin
{
    public abstract class ExpressPluginBase
    {
        ...
        public void UpdatePrintElement(IEnumerable<ExpressPrintElement> printElements)
        {
            ...
            string sDirectory = Mall.Core.Helper.IOHelper.urlToVirtual(WorkDirectory) + "/config.xml";
            ...
            Mall.Core.MallIO.CreateFile(sDirectory, stream2, Mall.Core.FileCreateType.Create);
        ...
        void RefreshExpressInfo()
        {
            ...
            if (configFile != null)
            {
                ...
                string sDirectory = Mall.Core.Helper.IOHelper.urlToVirtual(configFile.FullName);
