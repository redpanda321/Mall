...
namespace Mall.DTO
{
    ...
    /// 店铺信息表
    /// </summary>
    public class Shop:Mall.Entities.ShopInfo
    {
        /// <summary>
        /// 店铺ID
        /// </summary>
        ...
        /// 店铺进度
        /// </summary>
        public Mall.Entities.ShopInfo.ShopStage Stage { get; set; }

        /// <summary>
        /// 店铺状态
        /// </summary>
        public Mall.Entities.ShopInfo.ShopAuditStatus ShopStatus { get; set; }
        ...
        /// 商家类别
        /// </summary>
        public Mall.CommonModel.ShopBusinessType? BusinessType { get; set; }
