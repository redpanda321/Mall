...
namespace Mall.DTO.QueryModel
{
    public partial class RefundQuery : QueryBase
    {
        ...
        public List<OrderRefundInfo.OrderRefundAuditStatus> AuditStatusList { get; set; }
        ...
        public List<OrderRefundInfo.OrderRefundMode> RefundModes { get; set; }
        public long? ShopBranchId { get; set; }
        public bool IsOngoing { get; set; }
        public bool? IsFilterVirtual { get; set; }
    }
}
