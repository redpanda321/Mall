...
namespace Mall.DTO
{
    public class OrderListModel
    {
        ...
        /// 订单核销码集
        /// </summary>
        public List<OrderVerificationCodeInfo> OrderVerificationCodes { get; set; }
        /// <summary>
        /// 虚拟订单项
        /// </summary>
        public List<VirtualOrderItemInfo> VirtualOrderItems { get; set; }
        /// <summary>
        /// 订单发票信息
        /// </summary>
    ...
    public class OrderItem
    {
        ...
        public OrderRefundInfo Refund { get; set; }
        /// <summary>
        /// 核销码生效时间
        /// </summary>
        ...
        /// 虚拟订单信息项实体列表
        /// </summary>
        public List<VirtualOrderItemInfo> VirtualOrderItem { get; set; }
    }
}