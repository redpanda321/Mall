...
namespace Mall.API
{
    public class ShopSettlementController : BaseShopLoginedApiController
    {
        /// <summary>
        /// 获取店铺账户
        /// </summary>
        ...
        /// <returns></returns>
        /// 
        [HttpGet("GetCurrentSettlementCycle")]
        ...
        /// <returns></returns>
        /// 
        [HttpGet("GetPendingSettlementOrders")]
        ...
        /// <returns></returns>
        /// 
        [HttpGet("GetPendingOrderSettlementDetail")]
        ...
        [HttpGet("GetOrderSettlementDetail")]
        ...
        [HttpGet("GetShopYearSettledHistory")]
