...
namespace Mall.API
{
    public class ShopBranchCategoryController : BaseShopBranchLoginedApiController
    {
        ...
        {
            CheckUserLogin();
            var categories = _ishopCategoryService.GetMainCategory(CurrentShopBranch.ShopId);
