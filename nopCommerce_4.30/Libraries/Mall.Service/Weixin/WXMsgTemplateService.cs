...
namespace Mall.Service
{
    public class WXMsgTemplateService : ServiceBase, IWXMsgTemplateService
    {
        ...
        public WXMsgTemplateService(IWebHostEnvironment hostingEnvironment)
        {
        ...
        private string GetContentHandler(string strcontent, string appid, string appsecret)
        {
            ...
            foreach (var strUrl in GetHtmlImageUrlList(strcontent))
            {
                ...
                var filename = _hostingEnvironment.ContentRootPath + strUrl;
        ...
        /// </summary>
        /// <returns></returns>
        public Entities.WeiXinMsgTemplateInfo GetWeiXinMsgTemplate(Mall.Core.Plugins.Message.MessageTypeEnum type)
        {
        ...
        /// <returns></returns>
        public Entities.WeiXinMsgTemplateInfo GetWeiXinMsgTemplateByApplet(Mall.Core.Plugins.Message.MessageTypeEnum type)
        {
            int msgtype = (int)type;
        ...
        {
            Mall.Core.Plugins.Message.MessageTypeEnum _msgtype = (Mall.Core.Plugins.Message.MessageTypeEnum)info.MessageType;
        ...
        public void UpdateWeiXinMsgOpenState(Mall.Core.Plugins.Message.MessageTypeEnum type, bool isOpen)
        {
        ...
        public void SendMessageByTemplate(MessageTypeEnum type, long userId, WX_MsgTemplateSendDataModel data, string url = "", string wxopenid = "")
        {
            ...
            if (userId == 0)
            {
                ...
                {
                    throw new MallException("错误的OpenId");
                }
                openId = wxopenid;
            }
            else
            ...
            if (isdataok)
            {
                ...
                switch (type)
                {
                    ...
                    #endregion
                    default:
                        throw new MallException("无此模板消息，不能完成消息推送");
                        break;
                }
        ...
        /// </summary>
        /// <param name="type"></param>
        public string GetMessageTemplateShowUrl(Mall.Core.Plugins.Message.MessageTypeEnum type)
        {
            string result = "";
            ...
            if (_tmplinkdata != null)
            {
                if (!string.IsNullOrWhiteSpace(_tmplinkdata.ReturnUrl))
                {
                   ...
                   result = WebHelper.GetCurrentUrl();
        ...
        private string GetPlatformOpenIdByUserId(long userId)
        {
            ...
            if (userId > 0)
            {
                ...
                mo.ServiceProvider == "Mall.Plugin.OAuth.WeiXin" &&
                ...
                //            where mo.ServiceProvider == "Mall.Plugin.OAuth.WeiXin" && mo.AppIdType == MemberOpenIdInfo.AppIdTypeEnum.Payment
        ...
        public void AddMessageTemplate(Mall.Core.Plugins.Message.MessageTypeEnum? type = null)
        {
            var siteSetting = SiteSettingApplication.SiteSettings;
            string appid = siteSetting.WeixinAppId;
            string appsecret = siteSetting.WeixinAppSecret;
            ...
            {
                throw new MallException("获取Token失败");
            }
        ...
        #region 小程序消息模版
        public string GetWXAppletMessageTemplateShowUrl(Mall.Core.Plugins.Message.MessageTypeEnum type)
        {
            string result = "";
        ...
        /// </summary>
        /// <returns></returns>
        public Entities.WeiXinMsgTemplateInfo GetWXAppletMsgTemplate(Mall.Core.Plugins.Message.MessageTypeEnum type)
        {
            int msgtype = (int)type;
        ...
        public void SendAppletMessageByTemplate(MessageTypeEnum type, long userId, WX_MsgTemplateSendDataModel data, string url = "", string wxopenid = "", string formId = "")
        {
            ...
            if (userId == 0)
            {
                if (string.IsNullOrWhiteSpace(wxopenid))
                {
                    throw new MallException("小程序：错误的OpenId");
                }
                openId = wxopenid;
            }
            else
            ...
            if (isdataok)
            {
                ...
                switch (type)
                {
                    ...
                    #endregion
                    default:
                        throw new MallException("小程序：无此模板消息，不能完成消息推送");
                        break;
                }
                var wxhelper = new Weixin.WXHelper();
