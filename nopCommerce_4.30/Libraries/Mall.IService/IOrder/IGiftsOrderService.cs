...
namespace Mall.IServices
{
    public interface IGiftsOrderService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<GiftOrderInfo> GetOrders(GiftsOrderQuery query);
        int GetOrderCount(GiftsOrderQuery query);
        /// <summary>
        /// 获取订单
        /// </summary>
        /// <param name="ids"></param>
        /// <returns></returns>
        List<GiftOrderInfo> GetOrders(IEnumerable<long> ids);
        /// <summary>
        /// 获取订单计数
        /// </summary>
        ...
        List<GiftOrderItemInfo> GetOrderItemByOrder(long id);
        List<GiftOrderItemInfo> GetOrderItemByOrder(List<long> orders);
        /// <summary>
        /// 关闭订单
        /// </summary>
        /// <param name="orderId"></param>
