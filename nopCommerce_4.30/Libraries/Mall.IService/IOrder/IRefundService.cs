...
namespace Mall.IServices
{
    ...
    public interface IRefundService : IService
    {
        ...
        List<OrderRefundInfo> GetOrderRefundsByOrder(long order);
        List<OrderRefundInfo> GetOrderRefundsByOrder(IEnumerable<long> orders);
        /// <summary>
        /// 获取一条退货记录
        /// </summary>
        /// <param name="id"></param>
        ...
        Entities.OrderRefundInfo GetOrderRefund(long id, long? userId = null, long? shopId = null);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Entities.OrderRefundInfo GetOrderRefundById(long id);
        ...
        /// <returns></returns>
        QueryPageModel<Entities.OrderRefundInfo> GetOrderRefunds(RefundQuery refundQuery);
        /// <summary>
        /// 获取退款/退货记录数
        /// </summary>
        /// <param name="query"></param>
        /// <returns></returns>
        int GetOrderRefundCount(RefundQuery query);
        ...
        /// <param name="refundQuery"></param>
        /// <returns></returns>
        List<OrderRefundInfo> GetAllOrderRefunds(RefundQuery refundQuery);
        ...
        void SellerDealRefund(long id, Entities.OrderRefundInfo.OrderRefundAuditStatus auditStatus, string sellerRemark, string sellerName);
        ...
        /// <param name="id"></param>
        /// <param name="sellerName"></param>
        void SellerConfirmRefundGood(long id, string sellerName, string remark = "");
        /// <summary>
        /// 是否可以申请退款
        /// </summary>
        /// <param name="orderId"></param>
        ...
        /// <returns></returns>
        List<OrderRefundLogInfo> GetRefundLogs(long refundId, int currentApplyNumber = 0, bool haveCurrentApplyNumber = true);
        /// <summary>
        /// 删除售后原因
        /// </summary>
        /// <param name="id"></param>
