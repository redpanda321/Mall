...
namespace Mall.IServices
{
    ...
    public interface ISearchProductService : IService
	{
        ...
        void UpdateBrand(Entities.BrandInfo brand);
        /// <summary>
        /// 修改分类名称
        /// </summary>
        /// <param name="category"></param>
        void UpdateCategory(Entities.CategoryInfo category);
        ...
        void UpdateSearchProductPrice(long productId, long shopId, decimal newPrice);

        SearchProductInfo GetSingleSearchProductInfo(long productId, long shopId);
    }
}
