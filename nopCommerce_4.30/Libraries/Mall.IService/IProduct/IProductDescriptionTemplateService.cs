...
namespace Mall.IServices
{
    ...
    public interface IProductDescriptionTemplateService : IService
    {
        ...
        /// <returns></returns>
        QueryPageModel<ProductDescriptionTemplateInfo> GetTemplates(long shopId, int pageNumber, int pageSize, string name = null, ProductDescriptionTemplateInfo.TemplatePosition? position = null);
        ...
        /// <param name="shopId">店铺id</param>
        /// <returns></returns>
        List<ProductDescriptionTemplateInfo> GetTemplates(long shopId);
