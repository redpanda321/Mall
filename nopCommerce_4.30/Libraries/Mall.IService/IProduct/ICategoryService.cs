...
namespace Mall.IServices
{
    public interface ICategoryService : IService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        IEnumerable<CategoryInfo> GetCategoryByParentId(long id, bool justIsShow = true);
        List<CategoryInfo> GetAllCategoryByParent(long id);
        ...
        /// <returns></returns>
        List<CategoryInfo> GetValidBusinessCategoryByParentId(long id);
        ...
        IEnumerable<Entities.CategoryInfo> GetParentCategoryById(long id, bool isshow);
        /// <summary>
        /// 获取传入分类的所有一级分类
        /// </summary>
        ...
        /// <returns></returns>
        List<CategoryInfo> GetCateogryListByIds(List<long> ids);
