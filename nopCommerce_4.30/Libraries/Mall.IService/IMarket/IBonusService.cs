...
namespace Mall.IServices
{
    public interface IBonusService : IService
    {
        ...
        QueryPageModel<BonusInfo> Get(BonusQuery query);
        ...
        ///  获取红包详情
        /// </summary>
        QueryPageModel<BonusReceiveInfo> GetDetail( long bonusId , int pageIndex , int pageSize );
        ...
        /// 领取活动红包
        /// </summary>
        object Receive( long id , string openId, string unionId);
        ...
        decimal GetFirstReceivePriceByBonus(long bonus);
