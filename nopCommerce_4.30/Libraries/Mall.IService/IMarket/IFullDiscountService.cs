...
namespace Mall.IServices
{
    ...
    public interface IFullDiscountService : IService
    {
        ...
        void AddActive(ActiveInfo data, IEnumerable<FullDiscountRuleInfo> rules, IEnumerable<ActiveProductInfo> products);
        /// <summary>
        /// 更新满减活动
        /// </summary>
        /// <param name="data"></param>
        /// <param name="rules"></param>
        /// <param name="products"></param>
        void UpdateActive(ActiveInfo data, IEnumerable<FullDiscountRuleInfo> rules, IEnumerable<ActiveProductInfo> products);
        /// <summary>
        /// 删除满减活动
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <returns></returns>
        List<Entities.FullDiscountRuleInfo> GetActiveRules(long activeId);
        /// <summary>
        /// 获取满减商品
        /// </summary>
        /// <param name="activeId"></param>
        ...
        /// <param name="productIds"></param>
        /// <returns></returns>
        List<Entities.ActiveInfo> GetOngoingActiveByShopId(long shopId);
        ...
        /// <param name="shopId"></param>
        /// <returns></returns>
        List<Entities.ActiveInfo> GetOngoingActiveByProductIds(IEnumerable<long> productIds, long shopId);
        #endregion
        ...
        /// <param name="isShopCategroy"></param>
