...
namespace Mall.IServices
{
    public interface IVShopService : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        QueryPageModel<VShopInfo> GetVShopByParamete(VshopQuery vshopQuery);
        List<VShopExtendInfo> GetExtends(List<long> vShops);

        /// <summary>
        /// 获取热门微店
        /// </summary>
        /// <returns></returns>
		List<VShopInfo> GetHotShop(VshopQuery vshopQuery, DateTime? startTime, DateTime? endTime,out int total);
        ...
        /// <returns></returns>
        List<VShopInfo> GetHotShops(int page, int pageSize, out int total);

        /// <summary>
        /// 获取所有微店
        /// </summary>
        /// <returns></returns>
        List<VShopInfo> GetVShops();
        ...
        /// <returns></returns>
        List<VShopInfo> GetVShops(int page, int pageSize, out int total);
        ...
        /// <returns></returns>
        List<VShopInfo> GetVShops(int page, int pageSize, out int total, VShopInfo.VShopStates state,bool? IsOpenVshop);
        ...
        /// 开启或关闭微店
        /// </summary>
        void SetVShopIsOpen(long vshopId, bool isOpen);
        ...
        /// <returns></returns>
        List<VShopInfo> GetUserConcernVShops(long userId, int pageNo, int pageSize);
        /// <summary>
        /// 获取用户关注的微店数量
        /// </summary>
        /// <param name="userId"></param>
        /// <returns></returns>
        int GetFavoriteShopCountByUserId(long userId);
        ...
        /// <returns></returns>
        List<CouponSettingInfo> GetVShopCouponSetting(long shopid);
        /// <summary>
        /// 更新店铺优惠卷 设置 信息
        /// </summary>
