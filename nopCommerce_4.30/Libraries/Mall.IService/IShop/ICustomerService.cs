...
namespace Mall.IServices
{
    public interface ICustomerService : IService
    {
        ...
        /// </summary>
        List<CustomerServiceInfo> GetCustomerService(long shopId);
        ...
        List<CustomerServiceInfo> GetMobileCustomerService(long shopId);
        ...
        /// <returns></returns>
        List<CustomerServiceInfo> GetPlatformCustomerService(bool isOpen = false, bool isMobile = false);
