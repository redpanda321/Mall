...
namespace Mall.IServices
{
	...
	public interface IBillingService : IService
	{
		...
		/// <param name="query"></param>
		/// <returns></returns>
		List<ShopAccountItemInfo> GetAllShopAccountItem(ShopAccountItemQuery query);
		...
		/// <param name="query"></param>
		/// <returns></returns>
		List<PlatAccountItemInfo> GetAllPlatAccountItem(PlatAccountItemQuery query);
		...
		/// <returns></returns>
		PendingSettlementOrderInfo GetPendingSettlementOrderDetail(long orderId);
		...
		/// <param name="query"></param>
		/// <returns></returns>
		List<ShopWithDrawInfo> GetAllShopWithDraw(WithdrawQuery query);
        ...
        /// <param name="query"></param>
        /// <returns></returns>
        int GetShopWithDrawCount(WithdrawQuery query);
        ...
        /// <param name="shopId"></param>
        /// <returns></returns>
        decimal GetFrozenAmount(long shopId);

        /// <summary>
        /// 添加待结算订单
        /// </summary>
        /// <param name="model"></param>
        void AddPendingSettlementOrders(PendingSettlementOrderInfo model);
		...
		/// <returns></returns>
		QueryPageModel<PendingSettlementOrderInfo> GetPendingSettlementOrders(PendingSettlementOrderQuery query);
		...
		/// <param name="query">待结算订单查询实体</param>
		/// <returns></returns>
		List<PendingSettlementOrderInfo> GetAllPendingSettlementOrders(PendingSettlementOrderQuery query);
		...
		/// <param name="query"></param>
		/// <returns></returns>
		List<StatisticsPendingSettlement> AllStatisticsPendingSettlementOrders(StatisticsPendingSettlementQuery query);
		...
		/// <param name="query"></param>
		/// <returns></returns>
		List<AccountDetailInfo> GetAllSettlementOrders(SettlementOrderQuery query);
        ...
        void UpdateAccount(long shopId, decimal money,Mall.CommonModel.ShopAccountType TradeType, string AccountNo, string ChargeWay, long detailID = 0);
        ...
        /// </summary>
        /// <param name="Id"></param>
        void SetShopWithDrawSuccess(long Id);
    }
}
