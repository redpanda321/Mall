...
namespace Mall.IServices
{
    public interface IMemberInviteService : IService
    {
        ...
        //分页查询会员邀请积分记录
        QueryPageModel<InviteRecordInfo> GetInviteList(InviteRecordQuery query);
        ...
        //添加邀请积分邀请记录
        void AddInviteIntegel(MemberInfo RegMember, MemberInfo InviteMember, bool hasEmailOrPhone = false);
    }
}
