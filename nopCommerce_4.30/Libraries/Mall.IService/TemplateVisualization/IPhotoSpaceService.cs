...
namespace Mall.IServices
{
    public interface IPhotoSpaceService : IService
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<PhotoSpaceCategoryInfo> GetPhotoCategories(long shopId=0);
        ...
        /// <returns></returns>
        QueryPageModel<PhotoSpaceInfo> GetPhotoList(string keyword, int pageIndex, int pageSize, int order, long categoryId = 0, long shopId = 0);
