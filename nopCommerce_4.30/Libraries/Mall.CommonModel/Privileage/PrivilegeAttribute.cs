...
namespace Mall.CommonModel
{
    ...
    public class PrivilegeAttribute : Attribute
    {
        ...
        public Mall.CommonModel.AdminCatalogType AdminCatalogType { get; set; }
        /// <summary>
        ...
        public PrivilegeAttribute(string groupName, string name, int pid, string url, string controller, string action = "", Mall.CommonModel.AdminCatalogType type = Mall.CommonModel.AdminCatalogType.Default,string target="")
        {
            this.Name = name;
