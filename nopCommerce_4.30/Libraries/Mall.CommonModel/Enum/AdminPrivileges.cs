...
namespace Mall.CommonModel
{
    public enum AdminPrivilege
    {
        ...
        [Privilege("交易", "发票管理", 3008, "Order/InvoiceContext", "Order")]
        InvoiceContextManage = 3008,
        [Privilege("交易", "核销码记录", 3010, "VerificationCode/Management", "VerificationCode")]
        VerificationCode = 3010,
        ///*会员*/
        ...
        //MemberInvite = 4007,
        [Privilege("会员", "预存款管理", 4008, "Capital/Index", "Capital")]
        Capital = 4008,
        ...
        ShopPackage = 5002,
        [Privilege("店铺", "门店管理", 5006, "ShopBranch/Management", "ShopBranch")]
        ShopBranchManagement = 5006,
        [Privilege("店铺", "周边门店设置", 5007, "NearShopBranch/NearShopBranchSetting", "NearShopBranch")]
        NearShopBranch = 5007,
        //[Privilege("店铺", "O2O小程序消息", 5008, "WXSmallProgram/EditWXO2OMessage", "WXSmallProgram")]
        //EditO2OWXMessage = 5008,
        [Privilege("店铺", "财务管理", 5003, "Billing/index", "Billing")]
        [Privilege("店铺", "财务管理", 5003, "account/SetSettlementWeek", "account")]
        ...
        [Privilege("系统", "站点设置", 7001, "SiteSetting", "Navigation")]
        PageSetting = 7001,
        ...
        [Privilege("分销", "分销设置", 7101, "DistributionConfig/BaseConfig", "DistributionConfig")]
        DistributionConfig = 7101,
        [Privilege("分销", "分销商品", 7102, "DistributionProduct/Management", "DistributionProduct")]
        DistributionProduct = 7102,
        [Privilege("分销", "销售员管理", 7103, "Distributor/Management", "Distributor")]
        Distributor = 7103,
        [Privilege("分销", "销售员等级", 7104, "DistributorGrade/Management", "DistributorGrade")]
        DistributorGrade = 7104,
        [Privilege("分销", "分销业绩", 7105, "Distribution/Rankings", "Distribution")]
        DistributorPerformance = 7105,
        [Privilege("分销", "佣金提现管理", 7106, "DistributionWithdraw/Management", "DistributionWithdraw")]
        DistributionWithdraw = 7106,
        ...
        Coupon = 9002,
        [Privilege("营销", "新人礼包", 9013, "CouponActivity/Index", "CouponActivity", "", AdminCatalogType.Internal)]
        CouponActivity = 9013,
        ...
        ShopBonus = 9005,
        [Privilege("营销", "礼品管理", 9006, "Gift/management", "Gift", "management", AdminCatalogType.Internal)]
        GiftManage = 9006,
        [Privilege("营销", "礼品兑换列表", 9007, "Gift/Order", "Gift", "Order", AdminCatalogType.Internal)]
        GiftOrder = 9007,
        [Privilege("营销", "签到", 9008, "SignIn/Setting", "SignIn", "", AdminCatalogType.Internal)]
        SignIn = 9008,
        /*专题*/
        [Privilege("营销", "移动端专题", 9009, "VTemplate/VHomepage", "VTemplate", "", AdminCatalogType.Internal)]
        [Privilege("营销", "移动端专题", 9009, "MobileTopic/management", "MobileTopic", "", AdminCatalogType.Internal)]
        [Privilege("营销", "移动端专题", 9009, "VTemplate/VHomepage", "MobileHomeProducts", "", AdminCatalogType.Internal)]
        [Privilege("营销", "移动端专题", 9009, "VTemplate/VHomepage", "TemplateVisualizationAjax", "", AdminCatalogType.Internal)]
        MobileTopic = 9009,
        ...
        PCTopic = 9010,
        [Privilege("营销", "积分商城首页设置", 9016, "Gift/AppManage", "Gift", "", AdminCatalogType.Internal)]
        //AppIntegralManage = 9016,
        Gift = 9016,
        [Privilege("营销", "充值赠送", 9017, "Marketing/RechargePresentRule", "Marketing", "RechargePresentRule", AdminCatalogType.Internal)]
        RechargePresentRule = 9017,
        ...
        Vshop = 10001,
        [Privilege("微商城", "底部导航栏", 10007, "Weixin/WXMobileFootMenu", "Weixin")]
        WXMobieFootMenu = 10007,
        ...
        //[Privilege("APP", "APP商品配置", 12003, "MobileHomeProducts/GetMobileHomeProducts", "MobileHomeProducts")]
        [Privilege("APP", "APP商品配置", 12003, "APPShop/ProductSetting", "APPShop")]
        APPProductSetting = 12003,

        [Privilege("APP", "APP首页配置", 12001, "APPShop/AppHomePageSetting", "APPShop", LinkTarget = CommonModel.TargetType.Blank)]
        APPShop = 12001,
