...
namespace Mall.CommonModel
{
    ...
    public static class CacheKeyCollection
    {
        ...
        /// 
        /// </summary>
        public const string RecruitmentSetting = "Cache-RecruitmentSetting";
        public static string YesterDayStatistics(long shop)
        {
            return string.Format("YesterDayStatistics-{0}", shop);
        }
        ...
        public static string CACHE_BRANCHCART(long userId)
        {
            return string.Format("BRANCHCART_{0}", userId);
        }
        //商品详情获取店铺信息
        ...
        public static string CACHE_SHOP_BRANCH_MARK(long id)
        {
            return string.Format("CACHE_SHOP_BRANCH_MARK_{0}", id);
        }
        #endregion
        ...
        /// <returns></returns>
        public static string CACHE_IMPORTPRODUCTPERCENT(string key)
        {
            return string.Format("CACHE_IMPORTPRODUCTPERCENT_{0}", key);
        }
        public static string CACHE_CACHEIMPORT(string key)
        {
            return string.Format("CACHE_CACHEIMPORT_{0}", key);
        }
        /// <summary>
        /// 商家导入淘宝/天猫商品数据结果
        /// </summary>
        /// <param name="shopId"></param>
        /// <returns></returns>
        public static string CACHE_IMPORTPRODUCTRESULT(string key)
        {
            return string.Format("CACHE_IMPORTPRODUCTRESULT_{0}", key);
        }
        public static string CACHE_IMPORTCANCLE(string key)
        {
            return string.Format("CACHE_IMPORTCANCLE_{0}", key);
        }
        /// <summary>
        /// 上传视频进度
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public static string CACHE_UPLOADVIDEO(string id)
        {
            return string.Format("CACHE_UPLOADVIDEO_{0}", id);
        }
        #endregion

        #region 3.2
        public const string GenerateDistributionRankingAsync = "Cache-GenerateDistributionRankingAsync";
        #endregion
    }
}
