...
namespace Mall.OpenApi
{
    ...
    public class ProductController : OpenAPIController
    {
        ...
        [HttpGet("GetProduct")]
        public object GetProduct([FromQuery]GetProductParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
        ...
        public object GetSoldProducts([FromQuery]GetSoldProductsParameterModel para)
        {
            #region 参数初始
            if (para==null)
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public object UpdateProductQuantity([FromBody]UpdateProductQuantityParameterModel para)
        {
            #region 参数初始
            if(para==null)
            {
        ...
        /// </summary>
        [HttpPost]
        public object UpdateProductApproveStatus([FromBody]UpdateProductApproveStatusParameterModel para)
        {
            #region 参数初始
            if (para == null)
            {
