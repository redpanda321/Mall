...
namespace Mall.SmallProgAPI
{
    public class VShopController : BaseApiController
    {
        ...
        public object GetIndexData(long vshopid)
        {
            ...
            if (vshop != null)
            {
                string homejson = Request.Scheme + "://" + Request.Path + "/Areas/SellerAdmin/Templates/smallprogvshop/" + vshop.ShopId + "/t1/data/default.json";
