    ...
    public static class Cache
    {
        ...
        private static void Load()
        {
            ...
            try
            {
                ...
                //cache =  EngineContext.Current.Resolve<ICache>();
                cache = EngineContext.Current.Resolve<ICache>();
       ...
       // }
        ...
        {
            Helper.Mall.Core.Helper.CacheHelper.Insert(key, data, cacheTime);
        }
        ...
        {
            return Helper.Mall.Core.Helper.CacheHelper.Get<T>(key);
        }
