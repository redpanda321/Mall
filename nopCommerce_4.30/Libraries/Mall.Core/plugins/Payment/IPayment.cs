...
namespace Mall.Core.Plugins.Payment
{
    ...
    public interface IPaymentPlugin:IPlugin
    {
        ...
        /// <returns></returns>
        PaymentInfo ProcessReturn(IHttpContextAccessor context);
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessNotify(IHttpContextAccessor context);
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessRefundReturn(IHttpContextAccessor context);
        ...
        /// <exception cref="ApplicationException"></exception>
        /// <returns></returns>
        PaymentInfo ProcessRefundNotify(IHttpContextAccessor context);
        /// <summary>
        /// 企业付款
        /// </summary>
        ...
        /// <param name="para"></param>
        /// <returns></returns>
        EnterprisePayNotifyInfo ProcessEnterprisePayNotify(IHttpContextAccessor context);
        /// <summary>
        /// 网站插件列表Url
        /// </summary>
