...
namespace Mall.Core
{
    ...
    public class ServiceCheck
    {
        ...
        /// 多门店小程序
        /// </summary>
        public int openMultiStoreSmallProg { get; set; }
        /// <summary>
        /// 是否授权商城小程序
        /// </summary>
        public int openMallSmallProg { get; set; }
        /// <summary>
        /// 商城APP
        /// </summary>
        ...
        /// WAP端+微信端
        /// </summary>
        public int openH5 { get; set; }
        /// <summary>
        /// PC端
        /// </summary>
        public int openPC { get; set; }
    }
    /// <summary>
    /// 授权验证
    /// </summary>
    public static class LicenseChecker
    {
        ...
        private static bool IsFilterHost(string host)
        {
            List<string> hosts = new List<string>() {
                @"\w.Malltest.kuaidiantong.cn",
                @"\w.Mall.kuaidiantong.cn",
        ...
        /// </summary>
        /// <returns></returns>
        public static bool Check(out string Msg, out bool isOpenStore, out bool isOpenShopApp, out bool isOpenPC, out bool isOpenH5, out bool isOpenApp, out bool isOpenMallSmallProg, out bool isOpenMultiStoreSmallProg, string host)
        {
            ...
            isOpenH5 = false;
            isOpenApp = false;
            isOpenMallSmallProg = false;
            isOpenMultiStoreSmallProg = false;
            ...
            try
            {
                ...
                string result = PostData(string.Format("{0}/valid.ashx", url),
                    "action=Mall&product=1&host=" + host);
                ...
                isOpenPC = check.openPC == 1;
                isOpenH5 = check.openH5 == 1;
                isOpenApp = check.openApp == 1;
                isOpenMallSmallProg = check.openMallSmallProg == 1;
                isOpenMultiStoreSmallProg = check.openMultiStoreSmallProg == 1;
