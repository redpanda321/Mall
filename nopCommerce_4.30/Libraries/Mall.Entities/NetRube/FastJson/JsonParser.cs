...
namespace NetRube.FastJson
{
	...
	internal sealed class JsonParser
	{
				...
				switch(LookAhead())
				{
					...
					default:
						...
						if(NextToken() != Token.Colon)
							throw new Exception(Constants.ExpectedColonAtIndexException.F(index));
		...
		private object ParseValue()
		{
			...
			throw new Exception(Constants.UnrecognizedTokenAtIndexException.F(index));
		}
		...
		private string ParseString()
		{
			...
			throw new Exception(Constants.UnexpectedlyReachedEndOfStringException);
		}
		...
		private Token NextTokenCore()
		{
			...
			throw new Exception(Constants.CouldNotFindTokenAtIndexException.F(--index));
		}
	}
}