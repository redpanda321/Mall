...
namespace NetRube
{
	...
	public class ArgumentNullOrEmptyException : ArgumentException
	{
		...
		public ArgumentNullOrEmptyException() : base(Constants.ArgumentNullOrEmptyException) { }

		/// <summary>使用导致此异常的参数的名称初始化 <see cref="ArgumentNullOrEmptyException"/> 类的新实例。</summary>
		/// <param name="paramName">导致异常的参数的名称。</param>
		public ArgumentNullOrEmptyException(string paramName) : base(Constants.ArgumentNullOrEmptyException, paramName) { }
