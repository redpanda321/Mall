...
namespace NetRube
{
    public static partial class Utils
    {
        ...
        {
            if (string.IsNullOrEmpty(str) || IsNullOrEmpty(strArray)) return false;
        ...
        /// <param name="value">要验证的对象</param>
        /// <returns>指示是否为结构数据</returns>
        public static bool IsStruct_(this object value)
        {
            if (null == value) return false;
            return value.GetType().IsStruct_();
        }
        #endregion
        ...
        public static bool IsValue_<T>(this T value)
        {
