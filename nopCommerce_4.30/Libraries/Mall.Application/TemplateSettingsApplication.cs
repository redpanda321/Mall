...
namespace Mall.Application
{
    ...
    {
        private static ITemplateSettingsService _iTemplateSettingsService =  EngineContext.Current.Resolve<ITemplateSettingsService>();
        /// <summary>
        ...
        public static TemplateVisualizationSettingInfo GetCurrentTemplate(long shopid)
        {
