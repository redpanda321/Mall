...
namespace Mall.BLL
{
    ...
    public class LimitOrderHelper
    {
        ...
        private static IOrderService iorder = Mall.ServiceProvider.Instance<IOrderService>.Create;
        private static ILimitTimeBuyService _iLimitTimeBuy = Mall.ServiceProvider.Instance<ILimitTimeBuyService>.Create;
        /// <summary>
        ...
        {
            if (Cache.GetCache().GetType().FullName =="Mall.Strategy.Redis")
                return true;
            else
                return false;
        }
