...
namespace Mall.Application
{
    ...
    {
        //private static ICategoryService _iCategoryService =  EngineContext.Current.Resolve<ICategoryService>();
        ...
        /// <param name="id">分类Id</param>
        /// <returns></returns>
        public static List<Mall.Entities.CategoryInfo> GetCateogryListByIds(List<long> ids)
        {
