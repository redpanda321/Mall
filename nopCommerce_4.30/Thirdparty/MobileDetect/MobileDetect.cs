...
namespace MobileDetect
{
    public class MobileDetect
    {
        ...
        {
            {
                "HTTP_ACCEPT", new Dictionary<string, object>
                {
                    {
                        "matches", new[]
                        {
            ...
            // Seen this on a HTC.
            {
                "HTTP_UA_CPU", new Dictionary<string, object>
                {
                    {
                        "matches", new[]
                        {
        ...
        protected static Dictionary<string, object> PhoneDevices = new Dictionary<string, object>
        {
            ...
            {
                "LG",
                "\bLG\b;|LG[- ]?(C800|C900|E400|E610|E900|E-900|F160|F180K|F180L|F180S|730|855|L160|LS840|LS970|LU6200|MS690|MS695|MS770|MS840|MS870|MS910|P500|P700|P705|VM696|AS680|AS695|AX840|C729|E970|GS505|272|C395|E739BK|E960|L55C|L75C|LS696|LS860|P769BK|P350|P500|P509|P870|UN272|US730|VS840|VS950|LN272|LN510|LS670|LS855|LW690|MN270|MN510|P509|P769|P930|UN200|UN270|UN510|UN610|US670|US740|US760|UX265|UX840|VN271|VN530|VS660|VS700|VS740|VS750|VS910|VS920|VS930|VX9200|VX11000|AX840A|LW770|P506|P925|P999|E612|D955|D802)"
            },
        ...
        protected static Dictionary<string, object> TabletDevices = new Dictionary<string, object>
        {
            ...
            {
                "AcerTablet",
                "Android.*; \b(A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810)\b|W3-810|\bA3-A10\b"
            },
            ...
            {
                "LenovoTablet",
                "IdeaTab|ThinkPad([ ]+)?Tablet|Lenovo.*(S2109|S2110|S5000|S6000|K3011|A3000|A1000|A2107|A2109|A1107|B6000|B8000|B8080-F)"
            },
            ...
            {
                "GenericTablet",
                "Android.*\b97D\b|Tablet(?!.*PC)|ViewPad7|BNTV250A|MID-WCDMA|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab"
            }
        };
        ...
        protected static Dictionary<string, object> Utilities = new Dictionary<string, object>
        {
            ...
            {
                "Bot",
                "Googlebot|DoCoMo|YandexBot|bingbot|ia_archiver|AhrefsBot|Ezooms|GSLFbot|WBSearchBot|Twitterbot|TweetmemeBot|Twikle|PaperLiBot|Wotbox|UnwindFetchor|facebookexternalhit"
            },
        ...
        protected static Dictionary<string, object> Properties = new Dictionary<string, object>
        {
            ...
            {"IE", new[] {"IEMobile/[VER];", "IEMobile [VER]", "MSIE [VER];"}},
            // http://en.wikipedia.org/wiki/NetFront
            {"NetFront", "NetFront/[VER]"},
            {"NokiaBrowser", "NokiaBrowser/[VER]"},
            {"Opera", new[] {" OPR/[VER]", "Opera Mini/[VER]", "Version/[VER]"}},
            ...
            {"Safari", new[] {"Version/[VER]", "Safari/[VER]"}},
            {"Skyfire", "Skyfire/[VER]"},
            {"Tizen", "Tizen/[VER]"},
            {"Webkit", "webkit[ /][VER]"},
 ...
 */
        ...
        public void SetHttpHeaders(NameValueCollection httpHeaders = null)
        {
            ...
            if (httpHeaders == null)
            {
               ...
               var dict = _httpContextAccessor.HttpContext.Request.Headers;

                foreach (var kvp in dict)
                {
                    httpHeaders.Add(kvp.Key.ToString(), kvp.Value.ToString());
                }
            ...
            foreach (string key in httpHeaders.AllKeys)
            {
                ...
                {
                    HttpHeaders.Add(key, httpHeaders[key]);
                }
            }
        }
        ...
        {
            UserAgent = !string.IsNullOrEmpty(userAgent) ? userAgent : _httpContextAccessor.HttpContext.Request.Headers[HeaderNames.UserAgent].ToString();
        }
        ...
        public void SetDetectionType(string type = null)
        {
            if (type == null)
            {
                type = DetectionTypeMobile;
            }

            if (type != DetectionTypeMobile && type != DetectionTypeExtended)
            {
                return;
            }
        ...
        public static Dictionary<string, object> GetMobileDetectionRules()
        {
            ...
            foreach (KeyValuePair<string, object> keyValuePair in TabletDevices)
            {
                rules.Add(keyValuePair.Key, keyValuePair.Value);
            }

            foreach (KeyValuePair<string, object> keyValuePair in OperatingSystems)
            {
                rules.Add(keyValuePair.Key, keyValuePair.Value);
            }

            foreach (KeyValuePair<string, object> keyValuePair in Browsers)
            {
                rules.Add(keyValuePair.Key, keyValuePair.Value);
            }
        ...
        public static Dictionary<string, object> GetMobileDetectionRulesExtended()
        {
            ...
            foreach (KeyValuePair<string, object> keyValuePair in Utilities)
            {
                rules.Add(keyValuePair.Key, keyValuePair.Value);
            }
        ...
        public bool CheckHttpHeadersForMobile()
        {
            ...
            {
                if (!string.IsNullOrEmpty(HttpHeaders.Get(mobileHeader.Key)))
                {
        ...
        protected bool MatchDetectionRulesAgainstUA(string userAgent = null)
        {
            ...
            foreach (KeyValuePair<string, object> rule in GetRules())
            {
        ...
        public bool IsTablet(string userAgent = null, NameValueCollection httpHeaders = null)
        {
            ...
            foreach (KeyValuePair<string, object> tabletDevice in TabletDevices)
            {
                if (Match(tabletDevice.Value as string, userAgent))
                {
                    return true;
                }
            }
        ...
        public bool Is(string key, string userAgent = null, NameValueCollection httpHeaders = null)
        {
            ...
            SetDetectionType(DetectionTypeExtended);
